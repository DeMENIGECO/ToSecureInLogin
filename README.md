...
> [!WARNING]
Quest sistema NON è sicuro al 100% perché:
- Tutto gira lato client
- I token sono modificabili
- Il JON è accessibile
...
Il codice sorgente di TSIL è disponibile in `src/tsil`. Altri strumenti sono nella cartella `src`.
